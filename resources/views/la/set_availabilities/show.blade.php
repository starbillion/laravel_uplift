...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $set_availability->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Set_Availabilities", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/set_availabilities/'.$set_availability->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Set_Availabilities", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.set_availabilities.destroy', $set_availability->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/set_availabilities') }}" data-toggle="tooltip" data-placement="right" title="Back to Set Availabilities"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'sunday_to')
						@la_display($module, 'sunday_from')
						@la_display($module, 'monday_to')
						@la_display($module, 'monday_from')
						@la_display($module, 'tuesday_to')
						@la_display($module, 'tuesday_from')
						@la_display($module, 'wednesday_to')
						@la_display($module, 'wednesday_from')
						@la_display($module, 'thursday_to')
						@la_display($module, 'thursday_from')
						@la_display($module, 'friday_to')
						@la_display($module, 'friday_from')
						@la_display($module, 'saturday_to')
						@la_display($module, 'saturday_from')
					</div>
				</div>
			</div>
		</div>

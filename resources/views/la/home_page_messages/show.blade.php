...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $home_page_message->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Home_Page_Messages", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/home_page_messages/'.$home_page_message->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Home_Page_Messages", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.home_page_messages.destroy', $home_page_message->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/home_page_messages') }}" data-toggle="tooltip" data-placement="right" title="Back to Home Page Messages"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'welcome_title')
						@la_display($module, 'welcome_logo')
						@la_display($module, 'welcome_message')
						@la_display($module, 'welcome_footer')
						@la_display($module, 'quote_title')
						@la_display($module, 'quote_logo')
						@la_display($module, 'quote_message')
						@la_display($module, 'quote_footer')
						@la_display($module, 'update_title')
						@la_display($module, 'update_logo')
						@la_display($module, 'update_message')
						@la_display($module, 'update_footer')
					</div>
				</div>
			</div>
		</div>

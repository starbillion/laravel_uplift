...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $plans_name->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Plans_Names", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/plans_names/'.$plans_name->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Plans_Names", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.plans_names.destroy', $plans_name->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/plans_names') }}" data-toggle="tooltip" data-placement="right" title="Back to Plans Names"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'plan_name')
						@la_display($module, 'hour_ride')
						@la_display($module, 'type')
						@la_display($module, 'plan_price')

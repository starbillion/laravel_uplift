...
class CreateUserRegistrationsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("User_registrations", 'user_registrations', 'password', 'fa-cube', [
            ["first_name", "First Name", "String", false, "", 0, 256, true],
            ["last_name", "Last Name", "String", false, "", 0, 256, true],
            ["email", "Email", "String", true, "", 0, 256, true],
            ["phone", "Phone", "Integer", false, "", 0, 11, false],
            ["user_role", "User Role", "Dropdown", false, "", 0, 0, true, "@user_roles"],
